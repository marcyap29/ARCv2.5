...
Let your response end naturally based on the content. Silence is a valid ending.`;
      ...
      if (conversationMode) {
        ...
        let modeInstruction = "";
        let lengthInstruction = "Provide comprehensive, detailed reflections of 4 paragraphs maximum (approximately 12-16 sentences). Responses should naturally flow and conclude at 4 paragraphs. If more detail is available or the user wants to explore further, you may subtly indicate this, but keep the response focused and complete. Avoid bullet points.";
        ...
        switch (conversationMode) {
          ...
          case "reflectDeeply":
            ...
            lengthInstruction = "Provide an extensive, in-depth exploration of 4 paragraphs maximum (approximately 12-16 sentences). Responses should naturally flow and conclude at 4 paragraphs. If more detail is available or the user wants to explore further, you may subtly indicate this, but keep the response focused and complete. Avoid bullet points.";
            break;
