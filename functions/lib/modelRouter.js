...
class ModelRouter {
     ...
     */
    static selectModel(tier, operationType) {
     ...
     */
    static async selectModelWithFailover(tier, operationType) {
     ...
     */
    static async selectModelWithLocal(tier, operationType, preferLocal = false) {
