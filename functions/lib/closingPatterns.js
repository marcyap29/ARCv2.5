...
exports.CLOSING_PATTERNS = void 0;
exports.getClosingsByCategory = getClosingsByCategory;
exports.getClosingsByPhase = getClosingsByPhase;
exports.getClosingsByStyle = getClosingsByStyle;
/**
 * Pool of 75 closing lines organized by category
 */
exports.CLOSING_PATTERNS = [
 ...
 */
function getClosingsByCategory(category) {
    return exports.CLOSING_PATTERNS.filter(p => p.category === category);
}
/**
 * Get closing patterns by phase bias
 */
function getClosingsByPhase(phase) {
    return exports.CLOSING_PATTERNS.filter(p => p.phase_bias.includes(phase) || p.phase_bias.includes("Any"));
}
/**
 * Get closing patterns by style
 */
function getClosingsByStyle(style) {
    return exports.CLOSING_PATTERNS.filter(p => p.style === style);
}
//# sourceMappingURL=closingPatterns.js.map