...
exports.detectCrisisEnhanced = detectCrisisEnhanced;
// ============================================
// KEYWORD LIBRARY
// ============================================
...
function detectCrisis(text) {
    ...
    const confidence = Math.min((detectedPatterns.length * 20) + (intensityFactors.length * 5), 100);
    return {
...
// ============================================
function containsFalsePositiveMarkers(text) {
...
function detectCrisisEnhanced(text) {
...
//# sourceMappingURL=crisis_detector.js.map