...
class _JournalScreenState extends State<JournalScreen> with WidgetsBindingObserver {
  ...
  Future<void> _generateLumaraReflection() async {
    ...
    try {
      ...
      // Check if it's an API/connection issue (Groq, Gemini, timeout, or generic cloud AI)
      final msg = e.toString().toLowerCase();
      final isTimeout = e is TimeoutException || msg.contains('timed out') || msg.contains('timeout');
      if (isTimeout ||
