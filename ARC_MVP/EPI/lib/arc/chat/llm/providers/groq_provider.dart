...
// Groq API provider (Llama 3.3 70B) for LUMARA — fallback when Gemini unavailable
...
class GroqProvider extends LLMProviderBase {
  GroqProvider(LumaraAPIConfig apiConfig) : super(apiConfig, 'Groq (Llama 3.3 70B)', false);
