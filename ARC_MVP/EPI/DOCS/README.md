...
Use this list to orient quickly. For full inventory and sync status, see [CONFIGURATION_MANAGEMENT.md](CONFIGURATION_MANAGEMENT.md).

| Document | Purpose | When to read |
|----------|---------|--------------|
| **[overview.md](overview.md)** | What EPI and LUMARA are; pipeline and subsystems at a glance; where to read more. | First read for users and agents new to the repo. |
...
| **[CHANGELOG.md](CHANGELOG.md)** | Version history and release notes (v3.3.89 current). | What changed and when. |
