...
|--------------|---------|------------|--------|
| Subscription details fallback (`getUserSubscription`); premium Future cache (no paywall flicker); billing UI for founder / non-Stripe premium | v3.3.92 | — | 2026-03-30: `subscription_service.dart`, `subscription_management_view.dart`, `revenuecat_service.dart` (live `appl_` in `kRevenueCatIosApiKeyLive` per product choice). **Triage:** If `getSubscriptionDetails` is deployed later, fallback still safe; verify Stripe vs founder copy. |
...
| Doc-config-git-backup; Research Agent depth selector (Brief/Summary/Deep Dive) | v3.3.79 | — | 2026-03-10: research_screen depth SegmentedButton; research_agent quick_scan cap 3 sub-queries; synthesis_engine _depthLabelToSynthesisDepth. |
| Doc-config-git-backup; ARCX import progress phases; Chronicle Management UI simplification | v3.3.78 | — | 2026-03-10: arcx_import_service_v2 CHRONICLE phaseStart/phaseEnd, progress messages (changelog/voice/lumara intervals); chronicle_management_view: removed standalone import-from-ZIP/import-from-folder UI. |
| Doc-config-git-backup; ARCX CHRONICLE + pattern index; timeline refresh after restore; Chronicle export/import themes | v3.3.77 | — | 2026-03-10: ARCX export/import Chronicle/pattern_index/chronicle_index.json (ChronicleIndexStorage); chronicle_export_service, chronicle_import_service pattern index; unified_feed_screen 150ms delay then _feedRepo.refresh() on import complete; research_artifact_repository upsert/dedupe; lumara_assistant_cubit switchToSession return bool; llm_provider_factory Ollama. |
| Doc-config-git-backup; proxyOllama; ollama_send; FIREBASE_OLLAMA_DEPLOY; config; LUMARA/social/settings | v3.3.76 | — | 2026-03-10: proxyOllama Cloud Function; ollama_send.dart; FIREBASE_OLLAMA_DEPLOY.md; functions config; lumara_assistant_cubit, api_config, lumara_cloud_generate, lumara_settings_screen, draft_editor_screen, late_profile_service, social_accounts_screen; gemini_send, swarmspace_client; settings_view; swarmspaceRouter; claude.md. |
| Doc-config-git-backup; LUMARA settings; social/; research (search_orchestrator); draft_editor; swarmspaceRouter | v3.3.75 | — | 2026-03-10: lumara_settings_screen, agent_tips; research_agent, research_pipeline, search_orchestrator; draft_editor_screen; lib/lumara/social/, test/lumara/social/; swarmspaceRouter.ts. |
| Doc-config-git-backup; LUMARA settings; completed_form_export; research/vision/forms/profile; onboarding; settings_view | v3.3.74 | — | 2026-03-10: lumara_settings_screen, settings_view; completed_form_export_service; output_detail_screen, scan_action_sheet; research/vision/forms (content_brief, research_agent, research_pipeline, synthesis_engine, vision_ocr_screen, parsed_document, form_matcher); profile_fields_screen; arc_onboarding_cubit, arc_onboarding_sequence, phase_reveal_screen; prism_service. |
| Doc-config-git-backup; LUMARA settings/onboarding; forms/profile; outputs/agents | v3.3.73 | — | 2026-03-10: lumara_reflection_settings_service, lumara_settings_screen, lumara_splash_screen; onboarding (personality_reminder_screen, personality_setup_screen, arc_onboarding_*); outputs/agents refinements; forms/, profile/; prism_service, swarmspace_client; swarmspaceRouter. |
| Doc-config-git-backup; Outputs system; Firestore rules/index; SwarmSpace/research/vision/writing | v3.3.72 | — | 2026-03-10: Outputs (output_detail_screen, outputs_cubit, outputs_repository, etc.); FIREBASE_GEMINI_SECRET_SETUP, FIRESTORE_ACTIVITY_INDEX_AND_RULES, Key Commands, LUMARA_SWARMSPACE_BUILD_STATUS, SWARMSPACE_GEMINI_MODEL_ALIGNMENT; research_pipeline, content_brief, plugin_activity_screen; vision/; draft_editor_screen, pipeline_draft, style_profile_service; plugin_activity_log_service, prism_service; firestore.rules; tests. |
| Doc-config-git-backup; Vision OCR; Cloud Vision setup; LUMARA agents/research/writing | v3.3.71 | — | 2026-03-10: visionOcrInvoke, CLOUD_VISION_SETUP.md, LUMARA_MESSAGE_INJECTION.md; agent_tips, vision_ocr_screen; LUMARA/agents/research/writing/swarmspace/chronicle; claude.md. |
| Doc-config-git-backup; LUMARA assistant/API/settings; gemini_send; subscription | v3.3.69 | — | 2026-03-10: lumara_assistant_cubit, enhanced_lumara_api, lumara_settings_screen, gemini_send, subscription_service, lumara_subscription_status. |
