# Phase Rating System & Health Integration - Complete Guide
...
3. [Phase Rating Ranges](#phase-rating-ranges)
4. [Health Data Integration](#health-data-integration)
5. [Rating Calculation](#rating-calculation)
6. [Implementation Summary](#implementation-summary)
7. [Usage Examples](#usage-examples)
8. [API Reference](#api-reference)
9. [Commander Dashboard Integration](#commander-dashboard-integration)
...
1. **Phase Rating Ranges** (`lib/services/phase_rating_ranges.dart`)
...
2. **Health Auto-Detection** (`lib/services/health_data_service.dart`)
...
3. **Phase Context Extension** (`lib/services/phase_aware_analysis_service.dart`)
...
4. **Health-to-Phase Correlation** (`lib/services/phase_aware_analysis_service.dart`)
...
5. **Health-Adjusted Rating Calculation** (`lib/services/phase_aware_analysis_service.dart`)
   - Base rating from phase range + confidence
   - Health adjustment: -20 points (poor health) to +10 points (excellent health)
   - Final score clamped to 10-100 range

6. **Phase History Tracking** (`lib/prism/atlas/phase/phase_history_repository.dart`)
   - Phase history entries now include `operationalReadinessScore`
   - Health data snapshot stored in phase history
   - Historical tracking of readiness scores over time
