...
"""#
    ...
    // Token-lean task headers for on-device model (inject as user/instruction message before generation)
    static let chatLite = #"""
Task: Chat
...
"""#
    ...
    static let arcformKeywordsLite = #"""
Task: Arcform Keywords
Material:
- SAGE (optional): {{sage_json}}
- Entry:
