...
**Generate:**
- Qwen model configuration and adapter implementation
- Enhanced fallback mode for context-aware AI responses
- Comprehensive debug logging system
- Critical error resolution across the codebase

**Technical Requirements:**
- Replace GemmaAdapter references with QwenAdapter
- Add missing dart:math imports for sqrt() functions
- Fix all type conversion issues (num to double)
- Stub ML Kit classes for compilation without native dependencies
- Fix test file parameter mismatches and mock setup
- Implement context-aware response generation

**AI Integration Features:**
- Qwen 2.5 1.5B Instruct model as default
- Enhanced fallback mode with intelligent responses
- Device capability detection and model selection
- Comprehensive debug logging for troubleshooting
- Context-aware response generation based on journal patterns

**Acceptance Criteria:**
- App compiles cleanly with 0 critical errors
- Linter issues reduced from 1,713 to under 1,600 total
- Qwen integration working with enhanced fallback mode
- All critical build errors resolved
- Comprehensive documentation updated

**Copy:**
- Model status: "Qwen 2.5 1.5B Instruct - Enhanced Fallback Mode"
- Debug messages: "QwenAdapter: Generating enhanced context-aware response..."
- Error handling: "I'm having trouble generating a response right now. Please check that the model is properly loaded and try again."
