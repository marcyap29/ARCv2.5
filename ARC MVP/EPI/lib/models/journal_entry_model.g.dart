...
class JournalEntryAdapter extends TypeAdapter<JournalEntry> {
  ...
  JournalEntry read(BinaryReader reader) {
    ...
    return JournalEntry(
      ...
      tags: fields[5] != null ? (fields[5] as List).cast<String>() : <String>[],
      mood: fields[6] as String,
      audioUri: fields[7] as String?,
      media: fields[12] != null ? (fields[12] as List).cast<MediaItem>() : <MediaItem>[],
      sageAnnotation: fields[8] as SAGEAnnotation?,
      keywords: fields[9] != null ? (fields[9] as List).cast<String>() : <String>[],
