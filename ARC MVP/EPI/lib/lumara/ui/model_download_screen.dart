...
class _ModelDownloadScreenState extends State<ModelDownloadScreen> {
  ...
  static const List<ModelInfo> _availableModels = [
    ModelInfo(
      ...
      size: '~1.9 GB',
      downloadUrl: 'https://drive.google.com/file/d/1qOeyIFSQ4Q1WxVa0j271T8oQMnPYEqlF/view?usp=drive_link',
    ...
    ModelInfo(
      ...
      size: '~2.6 GB',
      downloadUrl: 'https://drive.google.com/file/d/1iwZSbDxDx78-Nfl2JB_A4P6SaQzYKfXu/view?usp=drive_link',
    ...
    ModelInfo(
      ...
      size: '~2.3 GB',
      downloadUrl: 'https://drive.google.com/file/d/1SwAWnUaojbWYQbYNlZ3RacIAN7Cq2NXc/view?usp=drive_link',
