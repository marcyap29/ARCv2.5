            ...
            child: Column(
              ...
              children: [
                ...
                if (widget.pointer.descriptor.duration != null)
                  Text(
                    _formatDuration(widget.pointer.descriptor.duration!),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  widget.pointer.descriptor.mimeType,
                  style: TextStyle(color: Colors.grey.shade600),
                ),
                if (widget.pointer.descriptor.sizeBytes > 0)
                  Text(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildMetadataRow('MIME Type', widget.pointer.descriptor.mimeType),
            if (widget.pointer.descriptor.sizeBytes > 0)
              _buildMetadataRow('Size', _formatFileSize(widget.pointer.descriptor.sizeBytes)),
            if (widget.pointer.descriptor.duration != null)
              _buildMetadataRow('Duration', _formatDuration(widget.pointer.descriptor.duration!)),
            _buildMetadataRow('Created', _formatDateTime(widget.pointer.createdAt)),
          ],
        ),
      ),
    );
