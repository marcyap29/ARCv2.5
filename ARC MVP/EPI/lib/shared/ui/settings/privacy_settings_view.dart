...
class _PrivacySettingsViewState extends State<PrivacySettingsView> {
  ...
  String _getPIITypeDisplayName(PIIType type) {
    switch (type) {
      ...
      case PIIType.healthInsurance:
        return 'Health Insurance Numbers';
  ...
  String _getPIITypeDescription(PIIType type) {
    switch (type) {
      ...
      case PIIType.macAddress:
        return 'MAC addresses and network hardware identifiers';
      case PIIType.licensePlate:
        return 'Vehicle license plate numbers';
      case PIIType.passport:
        return 'Passport numbers and travel documents';
      case PIIType.driverLicense:
        return 'Driver license numbers';
      case PIIType.bankAccount:
        return 'Bank account numbers';
      ...
      case PIIType.medicalRecord:
        return 'Medical record numbers and health data';
      case PIIType.healthInsurance:
        return 'Health insurance policy numbers';
      case PIIType.biometric:
        return 'Biometric identifiers and data';
      case PIIType.other:
