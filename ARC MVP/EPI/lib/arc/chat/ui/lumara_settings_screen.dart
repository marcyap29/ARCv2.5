      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Choose default provider and add API keys. LUMARA uses Groq by default; Gemini as fallback.',
            ...
            const SizedBox(height: 8),
            _buildDefaultProviderOption(theme, isDefaultGroq, isGroq: true),
            const SizedBox(height: 8),
            _buildDefaultProviderOption(theme, !isDefaultGroq, isGroq: false),
            const SizedBox(height: 24),
            // API keys
            Text(
              'API keys',
