...
class EnhancedLumaraApi {
  ...
  static const String _standardReflectionLengthRule =
      'Provide a comprehensive, detailed response of 4 paragraphs maximum (approximately 12-16 sentences). Draw connections to past journal entries when relevant. Use historical context to show patterns, evolution, and continuity in the user\'s experience. Responses should naturally flow and conclude at 4 paragraphs. If more detail is available or the user wants to explore further, you may subtly indicate this (e.g., "There are additional considerations we could explore" or "If you\'d like to dive deeper into any of these points..."), but keep the response focused and complete. Avoid bullet points. **REFLECTION DISCIPLINE**: Default to reflection-first, but feel free to offer gentle guidance, suggestions, goals, or habits when they naturally emerge from the reflection and feel helpful. You may use language like "This might be a good time to..." or "You might consider..." when patterns suggest helpful directions. You may end with questions like "Does this resonate?" or "What do you want to do next?" when they feel natural.';
  static const String _deepReflectionLengthRule =
      'Provide an extensive, in-depth exploration of 4 paragraphs maximum (approximately 12-16 sentences). Actively reference and analyze past journal entries to show longitudinal patterns, thematic evolution, and meaningful connections. Use historical context extensively to provide rich, contextualized reflection. Responses should naturally flow and conclude at 4 paragraphs. If more detail is available or the user wants to explore further, you may subtly indicate this (e.g., "There are additional considerations we could explore" or "If you\'d like to dive deeper into any of these points..."), but keep the response focused and complete. Avoid bullet points. **REFLECTION DISCIPLINE**: Default to reflection-first, but feel free to offer gentle guidance, suggestions, goals, or habits when they naturally emerge from the reflection and feel helpful. You may use language like "This might be a good time to..." or "You might consider..." when patterns suggest helpful directions. You may end with questions like "Does this resonate?" or "What do you want to do next?" when they feel natural.';
    ...
    try {
      ...
      try {
          ...
          if (request.options.conversationMode != null) {
            ...
            userPrompt = '$baseContext\n\n**COMPREHENSIVE REFLECTION**: $modeInstruction Provide 4 paragraphs maximum that address the CURRENT ENTRY while actively drawing connections to past journal entries from the historical context. Use historical entries to show patterns, evolution, and meaningful connections. Responses should naturally flow and conclude at 4 paragraphs. Follow the ECHO structure (Empathize → Clarify → Highlight → Open) with expanded detail. **REFLECTION DISCIPLINE**: Default to reflection-first, but feel free to offer gentle guidance, suggestions, goals, or habits when they naturally emerge from the reflection and feel helpful. You may end with questions when they feel natural. $lengthInstruction';
          } else if (request.options.regenerate) {
            // Regenerate: different rhetorical focus - FOCUS ON CURRENT ENTRY
            userPrompt = '$baseContext\n\n**COMPREHENSIVE REFLECTION**: Rebuild reflection from the CURRENT ENTRY marked above with different rhetorical focus. Provide 4 paragraphs maximum that actively reference past journal entries to show patterns and connections. Responses should naturally flow and conclude at 4 paragraphs. Randomly vary Highlight and Open while staying relevant to what the user just wrote. Keep empathy level constant. Follow ECHO structure with expanded detail. **REFLECTION DISCIPLINE**: Default to reflection-first, but feel free to offer gentle guidance, suggestions, goals, or habits when they naturally emerge from the reflection and feel helpful. You may end with questions when they feel natural. $_standardReflectionLengthRule';
          } else if (request.options.toneMode == models.ToneMode.soft) {
            // Soften tone - FOCUS ON CURRENT ENTRY
            userPrompt = '$baseContext\n\n**COMPREHENSIVE REFLECTION**: Rewrite in gentler, slower rhythm about the CURRENT ENTRY marked above. Provide 4 paragraphs maximum that draw connections to past journal entries for context and continuity. Responses should naturally flow and conclude at 4 paragraphs. Add permission language ("It\'s okay if this takes time."). Apply tone-softening rule for Recovery/Consolidation even if phase is unknown. Follow ECHO structure with expanded detail. **REFLECTION DISCIPLINE**: Default to reflection-first, but feel free to offer gentle guidance, suggestions, goals, or habits when they naturally emerge from the reflection and feel helpful. You may end with questions when they feel natural. $_standardReflectionLengthRule';
          } else if (request.options.preferQuestionExpansion) {
            // More depth - FOCUS ON CURRENT ENTRY
            userPrompt = '$baseContext\n\n**COMPREHENSIVE REFLECTION**: Expand Clarify and Highlight steps for richer introspection about the CURRENT ENTRY marked above. Provide 4 paragraphs maximum that extensively reference past journal entries to show patterns, evolution, and meaningful connections. Responses should naturally flow and conclude at 4 paragraphs. Add multiple reflective links that connect the current entry to historical patterns and themes. Follow ECHO structure with deep, detailed exploration. **REFLECTION DISCIPLINE**: Default to reflection-first, but feel free to offer gentle guidance, suggestions, goals, or habits when they naturally emerge from the reflection and feel helpful. You may end with questions when they feel natural. $_deepReflectionLengthRule';
          } else {
            // Default: first activation with rich context - EMPHASIZE CURRENT ENTRY
            userPrompt = '''$baseContext

**IMPORTANT INSTRUCTION**: Provide a comprehensive reflection of 4 paragraphs maximum that:
...
Follow the ECHO structure (Empathize → Clarify → Highlight → Open) but expand each section with detail. Include connections to past entries in your Highlight section. Consider the mood, phase, circadian context, recent chats, and any media when crafting your reflection. Responses should naturally flow and conclude at 4 paragraphs. If more detail is available or the user wants to explore further, you may subtly indicate this (e.g., "There are additional considerations we could explore" or "If you'd like to dive deeper into any of these points..."), but keep the response focused and complete. $_standardReflectionLengthRule''';
          }
