...
// 
// DEPRECATED: This file is kept for backward compatibility with on-device LLMs only.
// Cloud API uses the master prompt system (lumara_master_prompt.dart).
// See README_MASTER_PROMPT.md for the new unified system.
...
/// 
/// @deprecated This is for on-device LLMs only. Cloud API uses LumaraMasterPrompt.
/// See README_MASTER_PROMPT.md for the new unified master prompt system.
...
''';
  ...
  /// 
  /// @deprecated This method is deprecated. Cloud API uses LumaraMasterPrompt.
  /// This is kept for on-device LLM compatibility only.
  static Future<String> getSystemPromptForContext({
    String context = 'arcChat',
    Map<String, dynamic>? phaseData,
    Map<String, dynamic>? energyData,
  }) async {
    // Return legacy universal prompt for on-device compatibility
    return universal;
  }
}