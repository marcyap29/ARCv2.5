...
class ARCXCrypto {
  ...
  static func signData(_ data: Data) throws -> String {
    ...
    // The signature from CryptoKit is already Data type
  ...
  static func verifySignature(data: Data, signature: String) throws -> Bool {
    ...
    // CryptoKit's isValidSignature expects Data (bytes)
    // signature data from base64 decode is already Data
  ...
  static func encryptAEAD(_ plaintext: Data) throws -> Data {
    ...
    var nonceBytes = Data()
    sealedBox.nonce.withUnsafeBytes { bytes in
